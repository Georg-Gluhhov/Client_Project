...
export const ignore = [/^\/auth\/register\/?$/, /^\/auth\/login\/?$/, /^\/blog\.json$/, /^\/blog\/([^/]+?)\.json$/];
...
if (typeof window !== 'undefined') {
	import("C:/Users/opilane/source/repos/clientAPI--183362014_As_a_user_I_can_register/node_modules/sapper/sapper-dev-client.js").then(client => {
